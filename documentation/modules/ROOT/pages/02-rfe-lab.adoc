...
****
*NOTE:* If you are running this Lab in RHEL ARM, you might find this error while buiding your container image : `/usr/bin/crun: undefined symbol: criu_feature_check`. 
