...
****
*NOTE:* If you are running this Lab in ARM, you might find this error: `/usr/bin/crun: undefined symbol: criu_feature_check`. If you face this error you can try the https://access.redhat.com/discussions/6988326[published workaround], install this `crun` version in the system that will run the container:
