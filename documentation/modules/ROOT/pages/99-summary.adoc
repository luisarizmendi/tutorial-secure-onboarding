...
Now that you know what you are doing, you might find interesting to use my https://github.com/luisarizmendi/rhel-edge-quickstart[quickstart scripts to create RHEL for Edge images] so you can have (in few steps) any of the https://github.com/luisarizmendi/rhel-edge-quickstart/tree/master/demos[demos presented there] up and running.
