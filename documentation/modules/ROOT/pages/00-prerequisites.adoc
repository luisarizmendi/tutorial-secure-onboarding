...
If you are using Mac M1, this lab can be done using the https://access.redhat.com/downloads/content/419/ver=/rhel---9/9.1/aarch64/product-software[aarch64 version of RHEL] 9.0 or newer, 9.1 recommended. 
...
Instructions for the https://www.arthurkoziel.com/running-virt-manager-and-libvirt-on-macos/[setup of virt-manager and libvirt can be found here]: 

Requirements:
* https://docs.brew.sh/Installation[Brew]
* Python3 - part of the Xcode installation, or install using: `brew install python`
