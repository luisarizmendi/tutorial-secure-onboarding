...
Here you can find another configuration example, changing the Rendezvous IP address (under `rendezvous_info`) would be everything that you need to do if you use this file and follow the lab steps:
