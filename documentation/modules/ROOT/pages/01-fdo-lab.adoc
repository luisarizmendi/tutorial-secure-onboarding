...
Here you can find another configuration example, changing the Manufacturing IP address would be everything that you need to do if you use this file and follow the lab steps:
