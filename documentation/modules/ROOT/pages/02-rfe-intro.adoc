...
You can customize the image to configure the OS content as per your requirements by using either Image Builder installed on an RHEL system or using http://console.redhat.com[Red Hat Hybrid Console].
